...
var ViewParameterSweepSimulationModal = {
    ...
    getSimulationDescription: function(){
        $.ajax({
            ...
            error : function(xhr, status) {
                ...
                ErrorModal.errorMessage(" Simulación de barrido", "Error en la obtención de la descripción de la simulación de barrido de parámetro.");
            },
    ...
    getSimulationParameters: function(){
        $.ajax({
            ...
            error : function(xhr, status) {
                //show the error
                //manageRequestError(xhr, status);
                ErrorModal.errorMessage(" Simulación de barrido", "Error en la obtención de los parámetros de la simulación de barrido de parámetro.");
            },
    ...
    getSimulationOutputFiles: function(){
        $.ajax({
            ...
            error : function(xhr, status) {
                //show the error
                //manageRequestError(xhr, status);
                ErrorModal.errorMessage(" Simulación de barrido", "Error en la obtención de los ficheros de salida de la simulación de barrido de parámetro.");
            },
    ...
    setSimulationDescriptionTab: function(simulation){
        ...
        panel_content += '<div class="col-sm-6 col-md-6 col-lg-6 content-value">' + 'Barrido de parámetros' + '</div>';
        panel_content += '</div>';
    ...
    setSimulationParametersTab: function(parameters){
        ...
        for (var i = 0; i < parameters.length; i++){
            ...
            if (typeof param.values != 'undefined'){
                ...
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6"><span class="title">Valores</span></div>';
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6 content-value">' + param.values.join(", ") + '</div>';
                ...
                panel_content_html += '<div class="row">';
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6"><span class="title">Mínimo</span></div>';
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6 content-value">' + param.minValue + '</div>';
                panel_content_html += '</div>';
                
                panel_content_html += '<div class="row">';
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6"><span class="title">Incremento</span></div>';
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6 content-value">' + param.step + '</div>';
                panel_content_html += '</div>'; 
                
                panel_content_html += '<div class="row">';
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6"><span class="title">Máximo</span></div>';
                panel_content_html += '<div class="col-sm-6 col-md-6 col-lg-6 content-value">' + param.maxValue + '</div>';
                panel_content_html += '</div>'; 
